...
export async function fn1() {
    let result = await axios.get('https://comp426-1fa20.cs.unc.edu/a08/heroes');
...
export async function fn3() {
    ...
    let result = await axios.post('https://comp426-1fa20.cs.unc.edu/a08/users',{
        first: 'Ketan',
        last:  'Mayer-Patel',
        onyen: 'kmp',
    });
...
export async function fn5() {
  // let result = await axios.put('https://comp426-1fa20.cs.unc.edu/a08/headers', {headers: {"my-custom-request-header":"Hello, World!"},});
  // return result;
...
export async function fn6() {
  let result = await axios.get('https://comp426-1fa20.cs.unc.edu/a08/headers');
  let headerList = result.headers["my-custom-response-header"];
  return headerList;
};
